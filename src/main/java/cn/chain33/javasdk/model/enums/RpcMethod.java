...
public enum RpcMethod {
	...
	GET_BLOCK_OVERVIEW("Chain33.GetBlockOverview"),

	GET_BLOCK_DETAILS("Chain33.GetBlockByHashes"),
	...
	TOKEN_CREATE_MINT_TX("token.CreateRawTokenMintTx"),

	TOKEN_CREATE_BURN_TX("token.CreateRawTokenBurnTx"),
